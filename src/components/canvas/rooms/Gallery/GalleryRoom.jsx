...
const FALLBACK_PROJECTS = [
    {
        ...
        url: '#',
        description: 'Designed and developed an Arduino-based pick-and-place robot capable of accurately picking and placing objects at predefined locations using motor control and sensor feedback. The system used mechanical gripper integration, precise positioning, and smooth motion control for reliable object handling.',
    ...
    {
        id: 'sorting-conveyor',
        title: 'Camera-Based Sorting Conveyor',
        front: '/textures/gallery/timberkittyprzod.webp',
        painted: '/textures/gallery/timberkittyprzod_painted.webp',
        url: '#',
        description: 'Built a conveyor-based sorting system that used camera calibration and image processing to detect, identify, and sort objects based on visual features. Real-time synchronization between camera feedback and conveyor motion improved sorting precision and system efficiency.',
        techStack: ['/textures/gallery/pythonlogo.webp', '/textures/gallery/reactlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        id: 'tesla-coil',
        ...
        url: '#',
        description: 'Constructed a miniature Tesla Coil to demonstrate electromagnetic induction and wireless energy transfer. The prototype successfully lit fluorescent bulbs wirelessly using high-frequency alternating current, highlighting practical applications of resonant power transfer.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/reactlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        ...
        url: '#',
        description: 'Conducted field visits to nearby villages to study rural socio-economic conditions and the impact of heat, dust, and lack of infrastructure. The learning emphasized community engagement, problem observation, and practical understanding of livelihood challenges in real-world settings.',
