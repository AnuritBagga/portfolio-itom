...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'HARSH', subtitle: '< mechatronics engineer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'ACHIEVEMENTS', subtitle: '3rd Tekathon 3.0 • 2nd Tekathon 4.0' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'EDUCATION', subtitle: 'B.E. Mechatronics • Chandigarh University' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Automation • Sensors • CAD • Python • ROS2' },
];
