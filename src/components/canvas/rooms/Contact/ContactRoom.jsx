...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = 'mailto:harshthakur6647@gmail.com';
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/harsh-solanki-7751a6285/', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/harshsolanki', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* YOUTUBE */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="YOUTUBE"
                onClick={() => window.open('https://www.youtube.com/@harshsolanki', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="INSTAGRAM"
                onClick={() => window.open('https://www.instagram.com/harsh.solanki/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
