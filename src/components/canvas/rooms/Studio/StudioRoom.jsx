...
import { CONTENT_DATA, PLATFORM_CONFIG, getLatestContent, createStudioContactItems } from './contentData';
...
const StudioRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const activeContent = useMemo(
        () => sanityContent ? createStudioContactItems(sanityContent) : CONTENT_DATA,
        [sanityContent]
    );
