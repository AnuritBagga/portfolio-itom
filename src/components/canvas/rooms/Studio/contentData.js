 ...
 * 
 * Platforms: 'linkedin', 'instagram', 'email', 'phone'
 */
...
export const createStudioContactItems = (items) => [
    ...items.map((item) => {
        ...
        return {
            ...item,
            platform,
            title: platform === 'linkedin' ? 'Connect with me on LinkedIn' :
                platform === 'instagram' ? 'Follow me on Instagram' :
                    'Email me',
            description: platform === 'linkedin'
                ? 'Connect with Harsh Solanki on LinkedIn.'
                : platform === 'instagram'
                    ? 'Follow Harsh Solanki on Instagram.'
                    : 'Send an email to Harsh Solanki.',
            url: platform === 'linkedin'
                ? 'https://www.linkedin.com/in/harsh-solanki-7751a6285/'
                : platform === 'instagram'
                    ? 'https://www.instagram.com/harshh_thakur05/'
                    : 'mailto:harshthakur6647@gmail.com'
        };
    }),
    {
        id: 'phone-001',
        platform: 'phone',
        title: 'Call me',
        description: 'Call Harsh Solanki directly.',
        url: 'tel:+918755688171',
        date: '2026-01-01',
        frontTexture: '/textures/studio/phonefront_followmeontiktok.webp',
        paintedFrontTexture: '/textures/studio/phonefront_followmeontiktok_painted.webp',
    },
...
const STUDIO_CONTACT_DATA = createStudioContactItems(RAW_CONTENT_DATA);

let ytIdx = 0, blogIdx = 0, ttIdx = 0;
let ytPIdx = 0, blogPIdx = 0, ttPIdx = 0;

export const CONTENT_DATA = STUDIO_CONTACT_DATA.map((item) => {
    return {
        ...item,
