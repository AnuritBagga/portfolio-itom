...
const ROOM_META = {
    null: {
        path: '/',
        title: 'Harsh Solanki — Mechatronics Engineer',
        description: 'Portfolio of Harsh Solanki, a Mechatronics Engineering graduate with robotics, automation, sensors, CAD, and embedded systems experience.',
    },
    about: {
        path: '/about',
        title: 'About — Harsh Solanki',
        description: 'Learn about Harsh Solanki, a Mechatronics Engineering student with skills in automation, pneumatic systems, robotics, sensors, and CAD design.',
    },
    gallery: {
        path: '/gallery',
        title: 'Projects — Harsh Solanki',
        description: 'Explore Harsh Solanki’s mechatronics projects including a pick-and-place robot, sorting conveyor, and Tesla coil wireless power prototype.',
    },
    studio: {
        path: '/studio',
        title: 'Skills — Harsh Solanki',
        description: 'View Harsh Solanki’s technical skills in pneumatics, sensor integration, CAD software, Python, ROS2, and mechatronics design.',
    },
    contact: {
        path: '/contact',
        title: 'Contact — Harsh Solanki',
        description: 'Get in touch with Harsh Solanki through LinkedIn, GitHub, Instagram, YouTube, and email.',
    },
};
